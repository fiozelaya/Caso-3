...
class Circle:public Element{
    public:
        ...
        Element::setSide(newRadio);Element::setColor(newColor);};
...
class Rectangle:public Element{
    ...
    public:
        ...
        Element::setYCoord(newYCoord);Element::setSide(newHeight);Element::setColor(newColor);};
...
class Ellipse:public Element{
    private:
        double yRadio;
    public:
        Ellipse(){};//FALTA CAMBIAR LOS XRADIO POR SETSIDE
        ...
        Element::setColor(newColor);Element::setXCoord(newXCoord);Element::setYCoord(newYCoord);};
...
class Polyline:public Element{
    ...
    public:
        Polyline(){};
        Polyline(vector<vector<double>> newXYCoords){xyCoords=newXYCoords;};
...
class Polygon:public Element{
    ...
    public:
        Polygon(){};
        Polygon(vector<vector<double>> newCoords){xyCoords=newCoords;};
        void setXYCoord(vector<double> newxyCoords){xyCoords.push_back(newxyCoords);};
        vector<vector<double>> getXYCoord(){return xyCoords;};
        bool findMatchPosition(double pXValue, double pYValue);
        /*string getString(){return "Rectangle: X Value = "+to_string(Element::coordX)+" Y Value = "+to_string(Element::coordY)
...
class Line:public Element{
    ...
    public:
        ...
        endXValue=newEndXValue;endYValue=newEndYValue;};
...
class Path:public Element{
    ...
    public:
        ...
        curvePositions=newCurvePositions;};
